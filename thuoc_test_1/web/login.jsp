<%-- 
    Document   : login
    Created on : 15 Dec 2023, 1:34:19 pm
    Author     : admin
--%>
                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-4">
                                        <h3>ĐĂNG NHẬP</h3>
                                        <p>Chưa có tài khoản? <a href="registerServlet">
                                                Đăng ký</a></p>
                                    </div>
                                </div>
                            </div>  
                            <% if (session.getAttribute("error_login") != null) { %>
                            <p style="color: red;"><%= session.getAttribute("error_login") %></p>
                            <% } %>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-sm-3 justify-content-centerX">
                                        ...
                                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/thuoc_test_1/LoginGoogleHandler&response_type=code
                                           &client_id=146210714064-91fj87r4gmsnlonnetkj9j648iiglfed.apps.googleusercontent.com&approval_prompt=force" onclick="startGoogleSignIn()" class="btn btn-outline-danger bsb-btn-circle bsb-btn-circle-2xl">
