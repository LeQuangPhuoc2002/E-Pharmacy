                    ...
                    <form action="updateproductServlet" method="post" enctype="multipart/form-data">
                                ...
                                <select class="form-control" name="category_id">
                                    <c:forEach items="${listCategory}" var="category">
                                        <option value="${category.category_id}" 
                                                <c:if test="${category.category_id eq product.category_id}">selected</c:if>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                <br/>
                                <c:url value="assets/Image/${product.image}" var="imageURL" />
                                <img src="${imageURL}" alt="Preview" id="imagePreview" style="max-width: 100%; margin-top: 10px;">
                                <button type="button" id="removeImage">Xóa ảnh</button>
                            </div>
                        </div> <!-- form-group // -->
                        <br/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="description" placeholder="Sản phẩm ...">${product.description}</textarea>
                            </div>
                        </div> <!-- form-group // -->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <a href="adminServlet" class="btn btn-primary">Thoát</a>
